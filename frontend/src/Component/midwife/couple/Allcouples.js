          ...
          <div className="table-responsive">
            <table className="table table-striped">
              <thead>
                <tr>
                  <th scope="col">ID</th>
                  <th scope="col">Marriage Certificate No</th>
                  ...
                  {/* <th scope="col">Marriage Certificate Photo</th> */}
                ...
                {filteredData.length > 0 ? (
                  filteredData.map((couple, index) => (
                    <tr key={index}>
                      ...
                      {/* <td>
                        <img src={`http://localhost:8090/uploads/${couple.marriageno}.jpg`} alt="Marriage Certificate" style={{ maxWidth: '100px' }} />
                      </td> */}
                  ...
                  coupledetails.map((couple, index) => (
                    <tr key={index}>
                      ...
                      <td>{couple.familyPlan}</td>
                      {/* <td>
                        <img src={couple.marriageCertificatePhoto} alt={couple.marriageno} style={{ maxWidth: '100px' }} />
                      </td> */}
                      <td className="text-end">
                        <div className="d-flex flex-row justify-content-end gap-2">
                          <a href={`/viewcouple/${couple._id}`} className="btn btn-primary btn-small" alt="View">
