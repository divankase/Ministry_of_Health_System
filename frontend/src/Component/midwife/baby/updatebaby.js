...
export default function EditBaby() {
  ...
  function updateBaby(e) {
    ...
    axios
      .put(`http://localhost:8090/babydetails/editbaby/${id}`, updatedBaby)
      .then(() => {
        alert("Baby Updated");
  ...
  function handleDeleteBaby() {
    axios
      .delete(`http://localhost:8090/babydetails/deletebaby/${id}`)
      .then(() => {
        alert("Baby Deleted");
        window.location.href = "/allbaby";
      })
  ...
  return (
    <div>
      ...
      <div className="AllTableAdd">
        
        <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <div className='editBaby'><h1>Edit {Name}</h1></div>
        ...
        <form onSubmit={updateBaby}>
          ...
          <div className="row form-group mb-4">
            <div className="col">
              ...
              <input type="text" className="form-control" id="Weight" name="Weight" pattern="[0-9]+(\.[0-9]+)?" value={Weight} onChange={(e) => setWeight(e.target.value)} placeholder="Weight" required />
            </div>

            <div className="col">
              <label htmlFor="Height">Height</label>
              <input type="text" className="form-control" id="Height" name="Height" pattern="[0-9]+(\.[0-9]+)?" value={Height} onChange={(e) => setHeight(e.target.value)} placeholder="Height" required />
            </div>
          </div>
          ...
          <div className="row form-group mb-4">
            ...
            <div className="col">
              ...
              <input type="tel" className="form-control" id="phone" name="phone" pattern="07[0-9]{8}" maxLength={10} minLength={10} title="Phone number should start with 07 and have a total of 10 digits" value={phone} onChange={(e) => setphone(e.target.value)} placeholder="07X-XXXXXXX" required />
            </div>
          </div>
