    ...
    <div>
      ...
      <div className='tableMother'>
        ...
        <form onSubmit={b}>
          ...
          <div className="row form-group mb-4">
                <div className="col">
                  <label htmlFor="tel">Mobile Number(Whatsapp number) : </label>
                  <div className="input-group">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        // Restricting the first digit to 7, the second digit to 0, 1, 2, 4, 5, 6, or 7,
                        // and allowing any digit for the remaining seven digits
                        const firstDigit = inputValue.charAt(0);
                        const secondDigit = inputValue.charAt(1);
                
                        const allowedSecondDigits = ["0", "1", "2", "4", "5", "6", "7"];
                
                        if (
                            (firstDigit === '7') &&
                            (allowedSecondDigits.includes(secondDigit) || inputValue.length < 2) &&
                            (regex.test(inputValue) || e.nativeEvent.inputType === "deleteContentBackward")
                        ) {
